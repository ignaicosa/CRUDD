  ...
  if(arrayActividades === null){
    ...
    arrayActividades.forEach(element => {
      ...
      if(element.estado){
        ...
        listaActividadesUI.innerHTML += `<div class="alert" role="alert"><i class="material-icons float-left mr-2">✍🏼</i><b>${element.actividad}</b>  <span class="float-right"><i class="material-icons"></i><i class="material-icons">delete</i></span></div>`
      }
    });
  }
}
...
listaActividadesUI.addEventListener('click', (e) => {
  ...
  if(e.target.innerHTML === '✔' || e.target.innerHTML === 'delete'){
